...
const addressCreateSchema = z.object({
  ...
  number: z
    .string("Número deve ser um texto")
    .trim()
    .min(1, "Número é obrigatório"),
  complement: z.string("Complemento deve ser um texto").nullable(),
  neighborhood: z
    .string("Bairro deve ser um texto")
    .trim()
    .min(1, "Bairro é obrigatório"),
  city: z
    .string("Cidade deve ser um texto")
    .trim()
  ...
  state: z
    ...
    .pipe(
      z
        .string()
        .regex(ufRegex, "Estado deve ser a sigla com 2 letras (ex: SP)"),
    ),
  zipCode: z
...
export const userUpdateBodySchema = z.object({
  name: z
    ...
    .optional(),
  profileImageId: z
    .string("ID da imagem de perfil deve ser um texto")
    .trim()
    .uuid("ID da imagem de perfil deve ser um UUID válido")
    .optional(),
});
